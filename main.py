...
class RadarWidget(Widget):
    def __init__(self, **kwargs):
        ...
        self.beam_angle = 0.0          # current angle in degrees
        ...
        with self.canvas:
            ...
            # Rotating beam (slightly transparent)
    ...
    def _update_geometry(self, *args):
        ...
        # Update beam position based on current angle
    ...
    def update_beam(self, dt):
        # Advance angle and redraw beam only
...
class NexusVisionApp(MDApp):
    def build(self):
        # خلفية سوداء بالكامل (ويندوز + أندرويد)
